...
from Flask-Atomist-Test import create_app
...
def run_dev():
    ...
    """
    app.config.from_object("Flask-Atomist-Test.settings_dev")
    app.run()
...
def run_prod():
    ...
    """
    app.config.from_object("Flask-Atomist-Test.settings_prod")
